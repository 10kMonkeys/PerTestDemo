...
public class RW35_ReportWizardMultiSelectDetailedReportFromMultiSelectSalesLinksAndOptionsTest extends SampleTest {

    @Test
    public void reportWizardMultiSelectDetailedReportFromMultiSelectSalesLinksAndOptionsTest() {
        ...
        user.atCreateReportPage.moveFirstListingToSecondListingByDragging();
        user.atCreateReportPage.checkFirstAndSecondListingsAreReordered();
