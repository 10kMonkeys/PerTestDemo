...
//	@iOSXCUITFindBy(accessibility = "ADDRESS-61 WEST 62ND ST. #TEST")
    ...
    @AndroidFindBy(accessibility = "Select button: unselected 2 Water St. #68")
    ...
    @AndroidFindBy(accessibility = "ADDRESS: 2 Water St. #68")
...
//		universalVerticalSwipe(testListingWithOneAgentCheckbox);
    ...
    public void checkThatThreeListingsAreSelected(int swipes) {
        if (Config.isAndroid()) {
            resetSwipeOnlyAndroid(swipes);
            element(MobileBy.AccessibilityId("Select button: selected " + SessionVariables.getValueFromSessionVariable("listingAddress1"))).shouldBeVisible();
            element(MobileBy.AccessibilityId("Select button: selected " + SessionVariables.getValueFromSessionVariable("listingAddress2"))).shouldBeVisible();
            universalVerticalShortSwipe(element(MobileBy.AccessibilityId("Select button: selected " + SessionVariables.getValueFromSessionVariable("listingAddress1"))));
        } else {
