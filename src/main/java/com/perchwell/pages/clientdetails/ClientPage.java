...
public class ClientPage extends TechHelper {
	...
	@iOSFindBy(accessibility = "contactsViewCloseButton")
	...
	@iOSFindBy(accessibility = "invite_client_label")
	...
	@iOSFindBy(accessibility = "ContactsSearchBar")
	...
	@iOSFindBy(accessibility = "CLIENT TEST+CLIENT-TH-CHARTS")
	...
	@iOSFindBy(accessibility = "GROUPS")
	private WebElement groupsButton;

	@iOSFindBy(accessibility = "Transparent Background View")
...
//	@iOSXCUITFindBy(iOSClassChain = "**/XCUIElementTypeTable[1]")
	...
	@iOSFindBy(accessibility = "invite_agent_label")
