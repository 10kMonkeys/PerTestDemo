...
public class PerchwellPage extends TechHelper {
	...
	@iOSFindBy(accessibility = "EDIT SEARCH FILTERS OR SEARCH FOR A SPECIFIC ADDRESS")
	private WebElement editSearchFiltersHint;

	@iOSFindBy(accessibility = "MANAGE YOUR PROFILE, CONTACTS, DISCUSSIONS, AND TAGS")
	private WebElement manageYourProfileHint;

	@iOSFindBy(accessibility = "TRANSFORM DATA INTO MARKET INSIGHTS")
	private WebElement transformDataHint;

	@iOSFindBy(accessibility = "EXPLORE SEARCH RESULTS BY LOCATION")
    ...
    @iOSFindBy(accessibility = "Least Expensive")
    private WebElement leastExpensiveButton;

    @iOSFindBy(accessibility = "Most Expensive")
    private WebElement mostExpensiveButton;

	@iOSFindBy(accessibility = "Bathrooms")
	...
	@iOSFindBy(accessibility = "Newest")
	private WebElement newestSortButton;

//	@iOSFindBy(accessibility = "240 EAST 35TH ST. #TEST")
//	@iOSFindBy(accessibility = "ADDRESS-61 WEST 62ND ST. #TEST")
	...
	@iOSFindBy(accessibility = "ADDRESS: 240 East 35th St. #11A 474823")
	...
	@iOSFindBy(accessibility = "Number of selected listings: 3")
...
//		waitFor(sortType);
	...
	public void closeAccountMenu() {
		...
		action.tap(point(magnifierLocation.x, magnifierLocation.y)).release().perform();
	}
