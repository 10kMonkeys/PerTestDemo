...
public class SearchPage extends TechHelper {
    ...
    @iOSFindBy(accessibility = "ApplySearchButton")
    ...
    @iOSFindBy(accessibility = "LoadSavedSearchButton")
    ...
    @iOSFindBy(accessibility = "Remove Button: BROOKLYN")
    private WebElement deleteTagButtonBROOKLYN;

    @iOSFindBy(accessibility = "deleteTagButtonMANHATTAN")
    private WebElement deleteTagButtonMANHATTAN;

    @iOSFindBy(accessibility = "Remove Button: QUEENS")
...
//	@iOSXCUITFindBy(xpath = "*//XCUIElementTypeTable/XCUIElementTypeCell[1]/XCUIElementTypeStaticText[1]")
    ...
    @iOSFindBy(accessibility = "BEDROOMS Suboption: 3")
    private WebElement filterFor3Beds;

    @AndroidFindBy(accessibility = "Bedrooms: 4+")
    @iOSFindBy(accessibility = "BEDROOMS Suboption: 4+")
    ...
    @iOSFindBy(accessibility = "BATHROOMS Suboption: 2")
    private WebElement filterFor2Baths;

    @AndroidFindBy(accessibility = "Bathrooms: 4+")
    @iOSFindBy(accessibility = "BATHROOMS Suboption: 4+")
    ...
    @iOSFindBy(accessibility = "Fireplace-SELECTED")
    ...
    @iOSFindBy(accessibility = "Add Button: NEIGHBORHOODS")
    ...
    @iOSFindBy(accessibility = "Remove Button: Manhattan")
    ...
    @iOSFindBy(accessibility = "Neighborhood-Alphabet City")
    ...
    @iOSFindBy(accessibility = "Cell Collapsible Button: BEDROOMS")
    ...
    @iOSFindBy(accessibility = "Add Button: CUSTOM BOUNDARIES")
    ...
    @AndroidFindBy(xpath = "*//android.widget.LinearLayout[3]/android.widget.RelativeLayout/android.widget.ImageView")
    @iOSFindBy(accessibility = "Cell Collapsible Button: PROPERTY TYPE")
    private WebElement propertyTypeCollapseButton;

    @iOSFindBy(accessibility = "AddressSearchBar")
    private WebElement searchAddressField;

    @AndroidFindBy(accessibility = "Close Search Filters Button")
    @iOSFindBy(accessibility = "bar button: close search view")
    ...
    @iOSFindBy(accessibility = "Listing Activity Suboption: Listed")
    ...
    @iOSFindBy(accessibility = "brokerage: selected CORE Public")
    private String selectedCorePublicButton;

    @AndroidFindBy(xpath = "//*[@text='RESALE/SPONSOR']")
    @iOSFindBy(accessibility = "Cell Collapsible Button: RESALE/SPONSOR")
    private WebElement collapseReleaseSponsorArrow;

    @iOSFindBy(accessibility = "Cell Collapsible Button: LOCATION")
    ...
    @iOSFindBy(accessibility = "TOTAL ROOMS Maximum Value Input")
    private WebElement totalRoomsMaxValueField;

    @AndroidFindBy(accessibility = "Listing Activity Suboption: Price Drop")
    @iOSFindBy(accessibility = "Listing Activity Suboption: Price Drop")
    ...
    @iOSFindBy(accessibility = "BUILDINGS")
