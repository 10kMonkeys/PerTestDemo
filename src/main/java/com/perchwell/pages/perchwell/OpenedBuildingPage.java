...
public class OpenedBuildingPage extends TechHelper {
	...
	@iOSFindBy(accessibility = "DISCUSS THIS WITH YOUR CLIENT OR AGENT. WE'LL ORGANIZE YOUR MESSAGES BY PERSON & LISTING.")
	...
	@iOSFindBy(accessibility = "Compare Bar Button")
	private WebElement compareButton;

	@AndroidFindBy(xpath = "//*[@text='SEND WITHIN PERCHWELL']")
	@iOSFindBy(accessibility = "SEND WITHIN PERCHWELL")
	...
	@iOSFindBy(accessibility = "STUDIO")
	...
	@iOSFindBy(accessibility = "BUILDING LAUNDRY")
	...
	@iOSFindBy(accessibility = "Listing Preview Search TextField")
	...
	@iOSFindBy(accessibility = "Segmented Control: deselected MORE IN BUILDING")
	private WebElement moreInBuildingSection;

	@iOSFindBy(accessibility = "Segmented Control: deselected SIMILAR LISTINGS")
	private WebElement similarListingsSection;

	@iOSFindBy(accessibility = "Nav Back White")
	private WebElement backFromTagsButton;

	@iOSFindBy(accessibility = "BuildingViewBackButton")
	...
	@iOSFindBy(accessibility = "Collection View Cell: LEAST EXPENSIVE")
	private WebElement leastExpensiveButton;

	@iOSFindBy(accessibility = "Collection View Cell: MOST EXPENSIVE")
	private WebElement mostExpensiveButton;

	@iOSFindBy(accessibility = "Collection View Cell: BEDROOMS")
	private WebElement sortByBedroomsButton;

	@iOSFindBy(accessibility = "Collection View Cell Selected: MOST EXPENSIVE")
	private WebElement mostExpensiveSortButtonSelected;

	@iOSFindBy(accessibility = "Collection View Cell Selected: LEAST EXPENSIVE")
	private WebElement leastExpensiveSortButtonSelected;

	@iOSFindBy(accessibility = "Collection View Cell Selected: BEDROOMS")
	private WebElement bedroomsSortButtonSelected;

	@iOSFindBy(accessibility = "Segmented Control: deselected PAST LISTINGS")
	private WebElement pastListingsSection;

	@iOSFindBy(accessibility = "Segmented Control: deselected CURRENT LISTINGS")
	...
	@iOSFindBy(accessibility = "MORTGAGE CALCULATOR")
	...
	@iOSFindBy(accessibility = "Segmented Control: selected MORE IN BUILDING")
	private WebElement selectedMoreInBuildingSection;

	@iOSFindBy(accessibility = "Segmented Control: selected SIMILAR LISTINGS")
	private WebElement selectedSimilarListingsSection;

	@iOSFindBy(accessibility = "Segmented Control: selected PAST LISTINGS")
	private WebElement selectedPastListingsSection;

	@iOSFindBy(accessibility = "Segmented Control: selected CURRENT LISTINGS")
	private WebElement selectedCurrentListingsSection;

	@iOSFindBy(accessibility = "NO MATCH")
	...
	public void clickOnDeleteTagButton() {
		setImplicitTimeout(5, ChronoUnit.SECONDS);
...
//		int minY = listingMap.getLocation().getY() + 215;
		...
		new TouchAction(appiumDriver).tap(point(minX, minY)).release().perform();
	}
